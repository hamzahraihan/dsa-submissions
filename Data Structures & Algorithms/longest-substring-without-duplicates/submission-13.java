...
// simpan satu per satu huruf-huruf yang sudah ditemukan sebelumnya pada tipe data objek (hashset).
// jika ada huruf yang sama dengan huruf sebelumnya maka terjadi duplikasi
// jika ada duplikasi maka hapus huruf-huruf sebelumnya lalu simpan huruf baru
// ulangi langkah tersebut hingga mendapatkan substring terpanjang
...
space complexity = O(n) untuk n adalah extra space menyimpan karakter s
*/